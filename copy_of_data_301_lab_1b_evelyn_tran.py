# -*- coding: utf-8 -*-
"""Copy of DATA 301 Lab 1B - Evelyn Tran

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1_E9m6aPFwT1cGkLRBL0xKc4KkHpbXfYF
...
cond_sib_loc.T.plot.bar(stacked=True)
...
cond_golf_games.T.plot.bar(stacked=True)
...
joint_major_sports = pd.crosstab(df_survey["What is your major?"], df_survey["Do you consider yourself a sports fan?"], 
                                    normalize=True)
joint_major_sports
sports = joint_major_sports.sum(axis=0)
cond_major_sports = joint_major_sports.divide(sports, axis=1)
cond_major_sports.T.plot.bar(stacked=True)

"""There does not seem to be an obvious suggestion that major and being a sports fan are related. Computer Science is the most dominant major, followed by Statistics, and then Other in the "No" category; whereas, in "Yes" Computer Science is followed by Other and then Statistics. There is very minimal difference between the amount of Statistics and Other majors in the sports fan bar. Possibly there is a slight suggestion that more Statistics majors in the class are not sports fans, as there are double the proportion of Statisticians who are not sports than those who are. """